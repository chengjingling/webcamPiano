...
1. Made use of noteState to change colour and opacity of notes over time
2. Implemented the core p5.js sound library to play notes of the pentatonic scale when activated, ranging from C3 (most left) to C6 (most right)
3. Created a Note class that stores the note's size, position, state and pitch
*/
...
// faster method for calculating colour similarity which does not calculate root
